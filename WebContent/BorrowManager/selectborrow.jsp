...
<body>
<div class="box">
<div class="select"><form action="../SelectBorrowByStrkey" method="get">
	<label for="strkey">输入用读者证件号或者图书编号进行查找：</label><input type="text" name="strkey" id="strkey" size="30" maxlength='30' required>
