...
<form id="addform" action="../AddReaderServlet" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"><div class="info-form">
		...
		<div id="large"></div>
		<p><label for="maxnum">最大借书量：</label><input type="text" size="5"maxlength='2' name="maxnum" id="maxnum" maxlength='2'>本</p>
		<p><label for="money">押金：</label><input type="text" size="5" name="money" id="money">元</p>
		</div>
		</div>
		<div class="buttons">
