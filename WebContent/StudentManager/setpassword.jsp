...
<%
	...
	if(username == null){
		username = (String)session.getAttribute("zhanghao");
	}
%>
<div class="box">
<br><br><br>
...
<form action="../addadminServlet" method="post" onsubmit="return checkPassword()">
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;<input class="button" type="submit" value="提交">
<input class="button" type="reset" value="取消"></p>
</form>
</div>
</body>
</html>