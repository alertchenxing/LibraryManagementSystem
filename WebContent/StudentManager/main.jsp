	...
	<div class="middle">
		<div class="menu">
			<ul id="accordion" class="accordion">
				<li>
					<div class="link">个人信息管理<i class="fa-chevron-down"></i></div>
					<ul class="submenu">
						<li><a href="../SelectReaderServlet?strkey=<%=username%>" target="main">信息显示</a></li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul class="submenu">
						...
						<li><a href="../selectstudentborrowServlet?strkey=<%=username%>" target="main">图书归还</a></li>
					</ul>
				</li>
				<li>
					<div class="link">账户管理<i class="fa fa-chevron-down"></i></div>
					<ul class="submenu">
						<li><a href="updateadmin.jsp" target="main">修改密码</a></li>
					</ul>
				</li>
			</ul>
		</div>
		<div class="content"><iframe id="main" name="main" src="../login/welcome.jsp"></iframe></div>
	</div>
